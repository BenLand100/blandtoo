...
src_prepare() {
	epatch "${FILESDIR}/ffmpeg-4.1.patch"
}
...
pkg_postinst() {
	einfo "jellyfin was installed to ${INSTALL_DIR}, to start please use the init script /etc/init.d/jellyfin"
